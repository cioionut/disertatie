...
Scopul dezvoltării agenților conversaționali este de a îmbunătății interacțiunea dintre oameni și tehnologie. Prin caracterul său natural, această conexiune impune standarde ridicate în experiența utilizatorului și în eficiență de a rezolva cerințele acestuia. Luând în considerare fragilitatea unei conversații, dar și legătura dintre comportamentul agentului și experiența rezultată, de cele mai multe ori se recurge la implementări bazate pe reguli. Una dintre cela mai populare este cea bazată pe umplerea de sloturi (cadru de informații) care se caracterizează prin următoarele avantaje:
\begin{itemize}
...
\begin{description}
	...
	\item[Politicile de decizie (Dialog policy)] sunt acele metode prin care agentul decide să facă anumite acțiuni, de exemplu să întrebe despre un slot lipsă sau să interogheze sistemul rezolvând o anumită sarcină.
\end{description}

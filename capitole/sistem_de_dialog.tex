...
\begin{table}[htp]
	...
	\begin{tabular}{ c c c c} 
		...
		Seq2SeqX (bahdanau - general - attn) & 96.97 & 96.31 & 3.35 \\ % ok 
		\hline
		Seq2SeqX (bahdanau concat - attn) & 97.21 & 96.73 & - \\ % ok
		Seq2SeqX (bahdanau concat - attn) & 97.18 & 96.44 & 3.24 \\ % ok
		Seq2SeqX (bahdanau concat - attn) & 97.00 & 96.71 & 2.91 \\ % ok
		\hline
	\end{tabular}
	\caption{Antrenare simultană pentru detectarea intenției și recunoașterea entităților. Rezultatele pentru abordările anterioare sunt citate din \cite{att_joint_bing}}
	\label{rezultate2}
